...
// Pre: El mensaje apunta a un sector válido de memoria y fue creado el cifrado con cesar_crear().
int cesar_cifrar_mensaje(cesar_t* self, unsigned char* mensaje, ssize_t largo_mensaje); 

// Función para descifrar el mensaje con la clave almacenada. 
// Pre: El mensaje apunta a un sector válido de memoria y fue creado el cifrado con cesar_crear().
int cesar_descifrar_mensaje(cesar_t* self, unsigned char* mensaje, ssize_t largo_mensaje);
